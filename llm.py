...
def create_rag_chain():
    llm = OllamaLLM(model="llama3.2:1b-instruct-fp16")
...
# Function to process and combine two PDFs
def process_two_pdfs(pdf_path1, pdf_path2):
    splits1 = load_and_process_pdf(pdf_path1)
    splits2 = load_and_process_pdf(pdf_path2)
    combined_splits = splits1 + splits2  # Combine document splits
